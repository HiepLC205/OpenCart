...
class Header extends \Opencart\System\Engine\Controller {
	...
	public function index(): string {
		...
		// Quickview toast configuration (exposed to the view so the frontend can decide behaviour)
		$data['config_quickview_toast_autohide'] = $this->config->get('config_quickview_toast_autohide');
		$data['config_quickview_toast_timeout'] = $this->config->get('config_quickview_toast_timeout') ?: 5000;

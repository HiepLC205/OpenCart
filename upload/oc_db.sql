...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th12 09, 2025 lúc 06:45 AM
...
-- Cơ sở dữ liệu: `oc_db`
--
CREATE DATABASE IF NOT EXISTS `oc_db` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `oc_db`;
...
--
-- Cấu trúc bảng cho bảng `oc_address_format`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_address_format`
--
...
--
-- Cấu trúc bảng cho bảng `oc_antispam`
--
...
(1, 'Default', '', 1, '2025-12-05 08:48:31', '2025-12-05 08:48:31');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `oc_api_history`
--
...
--
-- Cấu trúc bảng cho bảng `oc_article_comment`
--
...
--
-- Cấu trúc bảng cho bảng `oc_article_rating`
--
...
--
-- Cấu trúc bảng cho bảng `oc_article_to_layout`
--
...
--
-- Cấu trúc bảng cho bảng `oc_country_description`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_country_description`
--
...
--
-- Cấu trúc bảng cho bảng `oc_cron`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_cron`
--
...
--
-- Cấu trúc bảng cho bảng `oc_customer_affiliate_report`
--
...
--
-- Cấu trúc bảng cho bảng `oc_customer_authorize`
--
...
--
-- Cấu trúc bảng cho bảng `oc_customer_token`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_custom_field`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_custom_field_customer_group`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_custom_field_description`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_custom_field_value`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_custom_field_value_description`
--
...
--
-- Cấu trúc bảng cho bảng `oc_download_report`
--
...
--
-- Cấu trúc bảng cho bảng `oc_gdpr`
--
...
--
-- Cấu trúc bảng cho bảng `oc_identifier`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_identifier`
--
...
--
-- Cấu trúc bảng cho bảng `oc_manufacturer_to_layout`
--
...
--
-- Cấu trúc bảng cho bảng `oc_marketing_report`
--
...
--
-- Cấu trúc bảng cho bảng `oc_notification`
--
...
--
-- Cấu trúc bảng cho bảng `oc_order_subscription`
--
...
--
-- Cấu trúc bảng cho bảng `oc_product_code`
--
...
--
-- Cấu trúc bảng cho bảng `oc_product_report`
--
...
--
-- Cấu trúc bảng cho bảng `oc_product_subscription`
--
...
--
-- Cấu trúc bảng cho bảng `oc_product_viewed`
--
...
(1, 43, 0, 'HIep', '1hai34nam6bayd naslkndklasndklasda', 3, 1, '2025-12-08 00:45:59', '2025-12-08 00:45:59'),
(2, 43, 0, 'hiệp', 'abcd', 1, 1, '2025-12-08 00:48:19', '2025-12-08 00:48:19'),
(3, 43, 0, '13214654', 'ads', 5, 1, '2025-12-08 00:49:43', '2025-12-08 00:49:43'),
(4, 40, 0, 'Hiệp', 'abcdefghiiklmn', 3, 1, '2025-12-08 04:41:05', '2025-12-08 04:41:05'),
(5, 42, 0, 'TUấn', 'Sản phẩm như bìu', 1, 1, '2025-12-08 06:42:29', '2025-12-08 06:42:29');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `oc_review_media`
--

CREATE TABLE `oc_review_media` (
  `media_id` int(11) NOT NULL,
  `review_id` int(11) NOT NULL,
  `type` varchar(10) NOT NULL COMMENT 'image hoặc video',
...
--
-- Đang đổ dữ liệu cho bảng `oc_review_media`
--

INSERT INTO `oc_review_media` (`media_id`, `review_id`, `type`, `file_path`, `sort_order`, `date_added`) VALUES
(1, 1, 'image', 'catalog/reviews/review_69361fc7e65e1_1765154759.png', 0, '2025-12-08 00:45:59'),
(2, 4, 'image', 'catalog/reviews/review_693656e1eb69f_1765168865.png', 0, '2025-12-08 04:41:05'),
(3, 5, 'image', 'catalog/reviews/review_693673559b32d_1765176149.png', 0, '2025-12-08 06:42:29');
...
('74253229de56fc5b5f687f4642', '{\"currency\":\"USD\",\"upload_token\":\"cf761614e50e504370e96bc663690bd2\",\"review_token\":\"6f6ff959edd2091886930fd281a65c0c\",\"wishlist\":[43],\"login_token\":\"a9b111596ee93efe03fb1232e1\"}', '2025-12-09 06:42:30');
...
(101, 0, 'config', 'config_email', '1@a.c', 0),
...
--
-- Cấu trúc bảng cho bảng `oc_startup`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_history`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_log`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_option`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_plan`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_subscription_plan`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_plan_description`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_subscription_plan_description`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_product`
--
...
--
-- Cấu trúc bảng cho bảng `oc_subscription_status`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_subscription_status`
--
...
--
-- Cấu trúc bảng cho bảng `oc_topic`
--
...
--
-- Cấu trúc bảng cho bảng `oc_topic_description`
--
...
--
-- Cấu trúc bảng cho bảng `oc_topic_to_layout`
--
...
--
-- Cấu trúc bảng cho bảng `oc_topic_to_store`
--
...
(1, 1, 'admin', '$2y$10$cJvdqAbB2u/PQmCpmmAsCe7ULYUWp1RE4Zeqg.JVQsI78h7iFODOS', 'John', 'Doe', '1@a.c', '', '', 1, '2025-12-05 08:48:31');

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `oc_user_authorize`
--
...
--
-- Cấu trúc bảng cho bảng `oc_user_login`
--
...
--
-- Cấu trúc bảng cho bảng `oc_user_token`
--
...
--
-- Cấu trúc bảng cho bảng `oc_zone_description`
--
...
--
-- Đang đổ dữ liệu cho bảng `oc_zone_description`
--
...
--
-- Chỉ mục cho bảng `oc_address_format`
--
ALTER TABLE `oc_address_format`
  ADD PRIMARY KEY (`address_format_id`);

--
-- Chỉ mục cho bảng `oc_antispam`
--
...
--
-- Chỉ mục cho bảng `oc_api_history`
--
...
--
-- Chỉ mục cho bảng `oc_article_comment`
--
...
--
-- Chỉ mục cho bảng `oc_article_rating`
--
...
--
-- Chỉ mục cho bảng `oc_article_to_layout`
--
ALTER TABLE `oc_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Chỉ mục cho bảng `oc_article_to_store`
--
...
--
-- Chỉ mục cho bảng `oc_country_description`
--
...
--
-- Chỉ mục cho bảng `oc_customer_affiliate_report`
--
...
--
-- Chỉ mục cho bảng `oc_customer_authorize`
--
...
--
-- Chỉ mục cho bảng `oc_customer_token`
--
...
--
-- Chỉ mục cho bảng `oc_download_report`
--
...
--
-- Chỉ mục cho bảng `oc_identifier`
--
...
--
-- Chỉ mục cho bảng `oc_manufacturer_to_layout`
--
...
--
-- Chỉ mục cho bảng `oc_marketing_report`
--
...
--
-- Chỉ mục cho bảng `oc_notification`
--
...
--
-- Chỉ mục cho bảng `oc_order_subscription`
--
...
--
-- Chỉ mục cho bảng `oc_product_code`
--
...
--
-- Chỉ mục cho bảng `oc_product_report`
--
...
--
-- Chỉ mục cho bảng `oc_product_subscription`
--
...
--
-- Chỉ mục cho bảng `oc_product_viewed`
--
...
--
-- Chỉ mục cho bảng `oc_review_media`
--
ALTER TABLE `oc_review_media`
...
--
-- Chỉ mục cho bảng `oc_subscription`
--
...
--
-- Chỉ mục cho bảng `oc_subscription_status`
--
...
--
-- Chỉ mục cho bảng `oc_topic`
--
ALTER TABLE `oc_topic`
  ADD PRIMARY KEY (`topic_id`);

--
-- Chỉ mục cho bảng `oc_topic_description`
--
...
--
-- Chỉ mục cho bảng `oc_topic_to_layout`
--
ALTER TABLE `oc_topic_to_layout`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Chỉ mục cho bảng `oc_topic_to_store`
--
...
--
-- Chỉ mục cho bảng `oc_user_authorize`
--
...
--
-- Chỉ mục cho bảng `oc_user_login`
--
ALTER TABLE `oc_user_login`
  ADD PRIMARY KEY (`user_login_id`);

--
-- Chỉ mục cho bảng `oc_user_token`
--
...
--
-- Chỉ mục cho bảng `oc_zone_description`
--
...
--
-- AUTO_INCREMENT cho bảng `oc_address_format`
--
ALTER TABLE `oc_address_format`
  MODIFY `address_format_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT cho bảng `oc_antispam`
--
ALTER TABLE `oc_antispam`
...
--
-- AUTO_INCREMENT cho bảng `oc_api_history`
--
ALTER TABLE `oc_api_history`
...
--
-- AUTO_INCREMENT cho bảng `oc_article_comment`
--
ALTER TABLE `oc_article_comment`
  MODIFY `article_comment_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_article_rating`
--
ALTER TABLE `oc_article_rating`
...
--
-- AUTO_INCREMENT cho bảng `oc_cron`
--
ALTER TABLE `oc_cron`
...
--
-- AUTO_INCREMENT cho bảng `oc_customer_affiliate_report`
--
ALTER TABLE `oc_customer_affiliate_report`
...
--
-- AUTO_INCREMENT cho bảng `oc_customer_authorize`
--
ALTER TABLE `oc_customer_authorize`
...
--
-- AUTO_INCREMENT cho bảng `oc_customer_token`
--
ALTER TABLE `oc_customer_token`
...
--
-- AUTO_INCREMENT cho bảng `oc_download_report`
--
ALTER TABLE `oc_download_report`
...
--
-- AUTO_INCREMENT cho bảng `oc_gdpr`
--
ALTER TABLE `oc_gdpr`
...
--
-- AUTO_INCREMENT cho bảng `oc_identifier`
--
ALTER TABLE `oc_identifier`
...
--
-- AUTO_INCREMENT cho bảng `oc_marketing_report`
--
ALTER TABLE `oc_marketing_report`
...
--
-- AUTO_INCREMENT cho bảng `oc_notification`
--
ALTER TABLE `oc_notification`
...
--
-- AUTO_INCREMENT cho bảng `oc_order_subscription`
--
ALTER TABLE `oc_order_subscription`
...
--
-- AUTO_INCREMENT cho bảng `oc_product_code`
--
ALTER TABLE `oc_product_code`
...
--
-- AUTO_INCREMENT cho bảng `oc_product_report`
--
ALTER TABLE `oc_product_report`
...
--
-- AUTO_INCREMENT cho bảng `oc_review_media`
--
ALTER TABLE `oc_review_media`
...
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=219;

--
-- AUTO_INCREMENT cho bảng `oc_startup`
--
ALTER TABLE `oc_startup`
...
--
-- AUTO_INCREMENT cho bảng `oc_subscription`
--
ALTER TABLE `oc_subscription`
  MODIFY `subscription_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_subscription_history`
--
ALTER TABLE `oc_subscription_history`
  MODIFY `subscription_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_subscription_log`
--
ALTER TABLE `oc_subscription_log`
  MODIFY `subscription_log_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_subscription_option`
--
ALTER TABLE `oc_subscription_option`
  MODIFY `subscription_option_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_subscription_plan`
--
ALTER TABLE `oc_subscription_plan`
  MODIFY `subscription_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT cho bảng `oc_subscription_product`
--
ALTER TABLE `oc_subscription_product`
  MODIFY `subscription_product_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_subscription_status`
--
ALTER TABLE `oc_subscription_status`
...
--
-- AUTO_INCREMENT cho bảng `oc_topic`
--
ALTER TABLE `oc_topic`
...
--
-- AUTO_INCREMENT cho bảng `oc_user_authorize`
--
ALTER TABLE `oc_user_authorize`
...
--
-- AUTO_INCREMENT cho bảng `oc_user_login`
--
ALTER TABLE `oc_user_login`
  MODIFY `user_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT cho bảng `oc_user_token`
--
ALTER TABLE `oc_user_token`
...
--
ALTER TABLE `oc_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4474;
...
('root', '2025-12-08 00:27:42', '{\"Console\\/Mode\":\"collapse\",\"lang\":\"vi\"}');
...
ALTER TABLE `pma__savedsearches`
  MODIFY `id` int(5) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- Cơ sở dữ liệu: `qlcsdl`
--
CREATE DATABASE IF NOT EXISTS `qlcsdl` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `qlcsdl`;
...
INSERT INTO `users` (`uid`, `fullName`, `password`, `dOb`) VALUES
('2221050002', 'Đào Anh Chử', '3c57eedda7da7d8ed036', NULL),
('2221050003', 'Đào Chu Giangj', 'd02500cc4fc4ff170e2a', NULL),
('2221050004', 'Doãn Anh Thanhnh', 'f1101144ad4ad9853432', NULL),
('2221050005', 'Doãn Đức Bình', '4ff9778018018fd2094b', NULL),
('2221050006', 'Đào Giang Đức', '3f6766dd92d92390672a', NULL),
('2221050007', 'Đào Văn Bình', '1c40bb746f46f611008f', NULL),
('2221050008', 'Đào Đức Đức', '9e9f001baebae31fe12f', NULL),
('2221050009', 'Đào Doãn Đẩu', '5db60053b83b82eca7dd', NULL),
('2221050010', 'An Cao Đẩu', '83cc77e16a16ad51cb6f', NULL),
('2221050011', 'An Cao Thương', '212a11120b20b891f918', NULL),
('2221050012', 'Giang Danh Giangj', '1fa89910fd0fdf09720f', NULL),
('2221050013', 'Đào An Ánh', '13cebb40d50d5054110d', NULL),
('2221050014', 'Đào Bùi Thương', 'ba1811b6dd6ddacfbfcb', NULL),
('2221050015', 'Doãn Bùi Chử', '92b5ff456e56e0f3d776', NULL),
('2221050016', 'An Bùi Duy Anh', 'f86ebb4cdecded6ed68d', NULL),
('2221050017', 'Doãn Cao Đẩu', '158b4467ac7ac68a18d7', NULL),
('2221050018', 'Giang Danh Dung', 'd0c844f5d05d0e4ea920', NULL),
('2221050019', 'Doãn Cao Chử', '6e82dd6f8cf8cc22d984', NULL),
('2221050002', 'Doãn Anh Đức', '3c57eedda7da7d8ed036', NULL),
('2221050003', 'Giang Bùi Đức', 'd02500cc4fc4ff170e2a', NULL),
('2221050004', 'Doãn Giang Đức', 'f1101144ad4ad9853432', NULL),
('2221050005', 'Doãn Doãn Giangj', '4ff9778018018fd2094b', NULL),
('2221050006', 'Chu Thị Thanhnh', '3f6766dd92d92390672a', NULL),
('2221050007', 'An Đức Đức', '1c40bb746f46f611008f', NULL),
('2221050008', 'Giang Văn Thương', '9e9f001baebae31fe12f', NULL),
('2221050009', 'Giang Đào Cường', '5db60053b83b82eca7dd', NULL),
('2221050010', 'Đào Chu Vũ', '83cc77e16a16ad51cb6f', NULL),
('2221050011', 'Đào Thị Duy Anh', '212a11120b20b891f918', NULL),
('2221050012', 'Chu Đức Vũ', '1fa89910fd0fdf09720f', NULL),
('2221050013', 'An Văn Ánh', '13cebb40d50d5054110d', NULL),
('2221050014', 'An Bùi Cường', 'ba1811b6dd6ddacfbfcb', NULL),
('2221050015', 'Giang Doãn Chử', '92b5ff456e56e0f3d776', NULL),
('2221050016', 'Giang Bùi Thanhnh', 'f86ebb4cdecded6ed68d', NULL),
('2221050017', 'Bùi Doãn Giangj', '158b4467ac7ac68a18d7', NULL),
('2221050018', 'Doãn Chu Đức', 'd0c844f5d05d0e4ea920', NULL),
('2221050019', 'Bùi An Bình', '6e82dd6f8cf8cc22d984', NULL),
('2221050020', 'Giang Văn Duy Anh', '5137cc95ef5ef1697778', NULL),
('2221050021', 'Bùi Đào Thương', '2383ccb8518518255d91', NULL),
('2221050022', 'An Bùi Dung', 'cc9944b6396396107e7a', NULL),
('2221050023', 'An Đức Đức', 'a78599952c52ca6ede28', NULL),
('2221050024', 'An Đức Ánh', '02af44ad7cd7c0b83cd7', NULL),
('2221050025', 'Doãn Bùi Cường', 'fa4dcc1622622401814f', NULL),
('2221050026', 'Đào Đức Chử', 'db0b779d33d339ef0e33', NULL),
('2221050027', 'Chu Đức Thương', 'cd49ee96ba6baa080ada', NULL),
('2221050028', 'Giang Chu Giangj', '201b665cbacba1517a62', NULL),
('2221050029', 'Đào Đức Thanhnh', 'e5431175fd5fd297df09', NULL),
('2221050030', 'An Văn Thanhnh', '0bee33baa4aa42a02247', NULL),
('2221050031', 'An Bùi Ánh', '8cafffde52e526fd27cf', NULL),
('2221050032', 'Giang Đức Dung', '3d07dd518d18d6fa3273', NULL),
('2221050033', 'Giang Thị Giangj', '3ef9bb6f0af0a51eea2f', NULL),
('2221050035', 'Khởi', 'c39499ba59a59ab20f88', '2005-11-11'),
('2221050036', 'Bùi Văn Duy Anh', 'd24577886e86e99d8e31', NULL),
('2221050038', 'Doãn Danh Duy Anh', '2c93bb3882882838ce77', NULL),
('2221050039', 'Doãn Đào Vũ', '27810003f63f68c6a7e4', NULL),
('2221050040', 'Doãn Đức Giangj', '232544251d51d2c17b44', NULL),
('2221050041', 'Chu Doãn Bình', '3d5abb48f38f390763c9', NULL),
('2221050042', 'Bùi An Đẩu', '4790eeafa6fa6d1e3a06', NULL),
('2221050043', 'Đào Đào Đức', '26f7442dfbdfb7ae2be2', NULL),
('2221050044', 'Đào Danh Chử', 'e46dcc852852820f475a', NULL),
('2221050045', 'Giang Đức Dung', '6e01dd96556553ebf012', NULL),
('2221050046', 'Chu Văn Giangj', 'c104ee0ec4ec46a8edb1', NULL),
('2221050047', 'Doãn Anh Duy Anh', '003b55662262226efec8', NULL),
('2221050048', 'Chu Đào Ánh', '211c88e680680b945dda', NULL),
('2221050049', 'Đào Anh Đức', 'c9bd889ed4ed40a50572', NULL),
('2221050050', 'An Thị Ánh', 'ec31dd901b01b5636120', NULL),
('2221050051', 'Chu Giang Bình', '5e1633ac2bc2b2639068', NULL),
('2221050052', 'Chu Anh Dung', '92f2aaea69a695337ade', NULL),
('2221050053', 'Giang Anh Thanhnh', '970677030b30b2a632c0', NULL),
('2221050054', 'Doãn Thị Đức', '4ecb0012bb2bbc3d2238', NULL),
('2221050055', 'Giang Giang Vũ', '0c61ccc7ef7efd55185c', NULL),
('2221050056', 'An Văn Duy Anh', '85feccbd13d13e7c5b71', NULL),
('2221050057', 'Doãn Anh Cường', '07f511c2d12d1bbe3136', NULL),
('2221050058', 'Bùi Bùi Giangj', '19b2666a5da5dc001eab', NULL),
('2221050059', 'Doãn Văn Thanhnh', '7875ddcd9ad9a04c8bd5', NULL),
('2221050060', 'An Đào Đức', 'c564440fc1fc160716fb', NULL),
('2221050061', 'Bùi Cao Vũ', 'ad77fff1d91d996d9f9b', NULL),
('2221050062', 'Chu Bùi Bình', '5385ee01751750614fa7', NULL),
('2221050063', 'Bùi Đức Đẩu', 'e38f330f61f618324477', NULL),
('2221050064', 'Giang Anh Ánh', '58e4ddc5585585415422', NULL),
('2221050065', 'An Đào Bình', 'af74bb8232232c3226e6', NULL),
('2221050066', 'An Thị Ánh', '454ebb931731763d6f30', NULL),
('2221050067', 'Giang Thị Vũ', 'dc37aa5c73c73e488a83', NULL),
('2221050068', 'Giang Văn Bình', 'b82799f51451478155e1', NULL),
('2221050069', 'Doãn An Ánh', '1ec988d5bc5bcbfd6162', NULL),
('2221050070', 'Giang Thị Dung', '4bde44d8c98c980cb73c', NULL),
('2221050071', 'Đào Chu Ánh', '26a799fa28a28249156c', NULL),
('2221050072', 'Chu Cao Cường', '486799f17c17cbd2e2a4', NULL),
('2221050073', 'Bùi Đức Chử', 'a6d95534cf4cf7a2c897', NULL),
('2221050074', 'Doãn Danh Duy Anh', 'c9ce44b47b47b1e00673', NULL),
('2221050075', 'Doãn Anh Cường', '5933558fddfddc647b79', NULL),
('2221050076', 'Doãn Danh Thương', '8646ddb1d91d9aa5b9c2', NULL),
('2221050077', 'Bùi Thị Duy Anh', '569b4409d79d712c7572', NULL),
('2221050078', 'Đào Cao Cường', '30d655f4b54b58fe79d4', NULL),
('2221050079', 'Đào Thị Đẩu', 'c43888e04a04a39409a4', NULL);
--
...
INSERT INTO `menu_items` (`id`, `name`, `price`, `type`) VALUES
(1, 'Phở bò', 50000.00, 'food'),
(2, 'Cơm gà', 45000.00, 'food'),
(3, 'Bún chả', 40000.00, 'food'),
(4, 'Coca Cola', 15000.00, 'drink'),
(5, 'Trà đá', 5000.00, 'drink'),
(6, 'Café sữa', 20000.00, 'drink'),
(7, 'Gà nấm', 100000.00, 'food');
...
(1, '10', '[]', 0.00, 'completed', '2025-11-17 02:50:21'),
(2, '1', '[{\"id\":\"6\",\"name\":\"Café sữa\",\"price\":\"20000.00\",\"type\":\"drink\",\"quantity\":1},{\"id\":\"5\",\"name\":\"Trà đá\",\"price\":\"5000.00\",\"type\":\"drink\",\"quantity\":1},{\"id\":\"1\",\"name\":\"Phở bò\",\"price\":\"50000.00\",\"type\":\"food\",\"quantity\":5},{\"id\":\"2\",\"name\":\"Cơm gà\",\"price\":\"45000.00\",\"type\":\"food\",\"quantity\":1},{\"id\":\"3\",\"name\":\"Bún chả\",\"price\":\"40000.00\",\"type\":\"food\",\"quantity\":1},{\"id\":\"4\",\"name\":\"Coca Cola\",\"price\":\"15000.00\",\"type\":\"drink\",\"quantity\":1}]', 375000.00, 'completed', '2025-11-17 02:54:14'),
(3, '1', '[{\"id\":\"4\",\"name\":\"Coca Cola\",\"price\":\"15000.00\",\"type\":\"drink\",\"quantity\":1},{\"id\":\"5\",\"name\":\"Trà đá\",\"price\":\"5000.00\",\"type\":\"drink\",\"quantity\":1},{\"id\":\"1\",\"name\":\"Phở bò\",\"price\":\"50000.00\",\"type\":\"food\",\"quantity\":1}]', 70000.00, 'pending', '2025-11-17 02:55:03');
...
(2, 'nhanvien', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'staff');
